...
When Rexy begins, there is no program in the compiler's hands yet. There is
...
and explains how Rexy breaks it into tokens. A token is a classified piece of
...
proved something more basic: the source has the grammar of a Rexy program. That
