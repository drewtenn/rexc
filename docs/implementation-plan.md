...
| [ ] | FE-104 | Emit readable generic instantiation diagnostics | FE-103 | M | bad generic call points at the *call site*, not the template (FR-025) | src/sema.cpp, src/diagnostics.cpp |
