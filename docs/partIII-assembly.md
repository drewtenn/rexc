...
turns `if/else` branches and `while` loops into labels and jumps. The same IR
can target i386 or x86_64 because the backend owns the target-specific choices.
