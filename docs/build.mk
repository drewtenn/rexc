...
docs/Rexc.pdf: $(PDF_FRONTMATTER) $(DOCS_SRC) $(COVER_ART) docs/epub-metadata.yaml $(PDF_METADATA) $(PDF_FILTER) $(PDF_TEMPLATE)
...
docs/Rexc.epub: $(EPUB_FRONTMATTER) $(DOCS_SRC) $(DIAGRAMS_PNG) $(COVER_ART) docs/epub.css docs/epub-metadata.yaml docs/strip-latex.lua
