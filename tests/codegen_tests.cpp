...
TEST_CASE(codegen_i386_emits_std_numeric_helper_calls)
{
	...
	REQUIRE(assembly.find("call print_char") != std::string::npos);
	REQUIRE(assembly.find("call println_char") != std::string::npos);
...
TEST_CASE(codegen_i386_emits_static_i32_scalar_load_and_store)
{
	...
	REQUIRE(assembly.find("movl .Lstatic_USER_COUNTER, %eax") != std::string::npos);
...
TEST_CASE(codegen_i386_emits_alloc_helper_calls)
{
	...
	REQUIRE(assembly.find("call owned_str_concat") != std::string::npos);
	REQUIRE(assembly.find("call slice_i32_from") != std::string::npos);
	REQUIRE(assembly.find("call result_i32_ok") != std::string::npos);
